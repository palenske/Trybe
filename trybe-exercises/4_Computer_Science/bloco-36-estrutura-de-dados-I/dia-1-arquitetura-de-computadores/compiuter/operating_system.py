...
from .main_memory import MainMemory # quando executada pelo arquivo exercise_01.py
from .secondary_memory import SecondaryMemory # quando executada pelo arquivo exercise_01.py
