...
def generate(path):
    ...
    for item in path:
        manufacturing_dates.append(item["data_de_fabricacao"])
    ...
    for manufacturing, expiration in
    zip (manufacturing_dates, expiration_dates):
        d1 = datetime.strptime(manufacturing, "%Y-%m-%d")
        d2 = datetime.strptime(expiration, "%Y-%m-%d")
        vencimento.append(abs((manufacturing - expiration).days)
    # closest_expiration_date = min(
    #    (manufacturing_dates[0]) - (expiration_dates[0])
    # )
    print(manufacturing_dates)

    # return oldest_manufacturing_date


print(generate(dict_files))
[
    ("2020-02-18", "2022-09-17"),
    ("2019-12-06", "2022-12-25"),
    ("2019-12-22", "2023-11-07"),
    ("2019-12-24", "2024-08-19"),
    ("2020-04-14", "2024-01-14"),
    ("2020-07-18", "2023-10-05"),
    ("2020-07-17", "2022-11-18"),
    ("2020-02-22", "2023-03-14"),
    ("2019-09-06", "2023-05-21"),
    ("2019-12-08", "2022-12-08"),
]
